...
def port_scan():
    ...
    common_ports = [21, 22, 23, 25, 53, 80, 110, 143, 443, 3306, 3389 ,544, 554,5900, 8080,8000, 8081,3000, 5000, 6379, 11211, 27017,5173, 6379,3000, 5000S, 9000, 9200, 9300, 11211, 27017
                    ]
    open_ports = []
